...
exports.getRoadmapByToken = getRoadmapByToken;
...
async function generateRoadmap(req, res) {
    try {
        ...
        if (!desired_role || !current_skills) {
            return (0, response_1.sendError)(res, "Skills and Desired Role are required.", 400);
        }
...
Experience Level: ${experience_level || "beginner"}`
        ...
        // Save to DB
        const roadmapId = (0, uuid_1.v4)();
        await (0, database_1.default)("saved_roadmaps").insert({
            id: roadmapId,
        ...
        return (0, response_1.sendError)(res, "Failed to generate learning roadmap.", 500);
    }
}
async function getRoadmapByToken(req, res) {
    try {
        const { token } = req.params;
        const roadmap = await (0, database_1.default)("saved_roadmaps").where({ share_token: token }).first();
        if (!roadmap) {
            return (0, response_1.sendError)(res, "Roadmap not found.", 404);
        }
        return (0, response_1.sendSuccess)(res, {
            id: roadmap.id,
        ...
        return (0, response_1.sendError)(res, "Failed to retrieve roadmap details.", 500);
    }
}
async function getSavedRoadmaps(req, res) {
    try {
        if (!req.user)
            return (0, response_1.sendError)(res, "Unauthorized", 401);
        const roadmaps = await (0, database_1.default)("saved_roadmaps")
        ...
        return (0, response_1.sendError)(res, "Failed to fetch user roadmaps.", 500);
    }
}
async function exportPdf(req, res) {
    try {
        ...
        return (0, response_1.sendError)(res, "Failed to export roadmap file.", 500);
    }
}
