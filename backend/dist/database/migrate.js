...
async function runMigrations() {
    ...
    try {
        // 1. USERS TABLE
        const hasUsers = await database_1.default.schema.hasTable("users");
        if (!hasUsers) {
            await database_1.default.schema.createTable("users", (table) => {
        ...
        // 2. CATEGORIES TABLE
        const hasCategories = await database_1.default.schema.hasTable("categories");
        if (!hasCategories) {
            await database_1.default.schema.createTable("categories", (table) => {
                table.string("id", 36).primary();
        ...
        // 3. TAGS TABLE
        const hasTags = await database_1.default.schema.hasTable("tags");
        if (!hasTags) {
            await database_1.default.schema.createTable("tags", (table) => {
                table.string("id", 36).primary();
        ...
        const hasArticles = await database_1.default.schema.hasTable("blog_articles");
        if (!hasArticles) {
            await database_1.default.schema.createTable("blog_articles", (table) => {
                table.string("id", 36).primary();
                table.string("slug").unique().notNullable();
        ...
        const hasArticleTags = await database_1.default.schema.hasTable("blog_article_tags");
        if (!hasArticleTags) {
            await database_1.default.schema.createTable("blog_article_tags", (table) => {
        ...
        // 6. COMMENTS TABLE
        const hasComments = await database_1.default.schema.hasTable("comments");
        if (!hasComments) {
            await database_1.default.schema.createTable("comments", (table) => {
                table.string("id", 36).primary();
                table.string("article_id", 36).references("id").inTable("blog_articles").onDelete("CASCADE");
        ...
        const hasToolHistory = await database_1.default.schema.hasTable("tool_history");
        if (!hasToolHistory) {
            await database_1.default.schema.createTable("tool_history", (table) => {
                table.string("id", 36).primary();
        ...
        const hasRoadmaps = await database_1.default.schema.hasTable("saved_roadmaps");
        if (!hasRoadmaps) {
            await database_1.default.schema.createTable("saved_roadmaps", (table) => {
                table.string("id", 36).primary();
        ...
        const hasValidations = await database_1.default.schema.hasTable("startup_validations");
        if (!hasValidations) {
            await database_1.default.schema.createTable("startup_validations", (table) => {
                table.string("id", 36).primary();
                table.string("user_id", 36).nullable().references("id").inTable("users").onDelete("CASCADE");
                table.string("share_token").unique().notNullable();
        ...
        const hasBookmarks = await database_1.default.schema.hasTable("user_bookmarks");
        if (!hasBookmarks) {
            await database_1.default.schema.createTable("user_bookmarks", (table) => {
                table.string("id", 36).primary();
                table.string("user_id", 36).references("id").inTable("users").onDelete("CASCADE");
        ...
        // 11. AUDIT_LOGS TABLE
        const hasAuditLogs = await database_1.default.schema.hasTable("audit_logs");
        if (!hasAuditLogs) {
            await database_1.default.schema.createTable("audit_logs", (table) => {
                table.string("id", 36).primary();
                table.string("user_id", 36).nullable().references("id").inTable("users").onDelete("SET NULL");
